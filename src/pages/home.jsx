      ...
      <nav className={`fixed top-0 w-full z-50 backdrop-blur-xl border-b ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <motion.div 
                className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-amber-400 to-orange-500 flex items-center justify-center"
                animate={{ rotate: [0, 360] }}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div className="text-center sm:text-left">
              <div className="flex items-center space-x-2 justify-center sm:justify-start mb-4">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className={`space-y-2 text-sm ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                ...
                <li><a href="#" className="hover:text-amber-400">Use Cases</a></li>
                <li><a href="#" className="hover:text-amber-400">Demo</a></li>
              </ul>
            </div>
